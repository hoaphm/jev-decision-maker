...
- Client failure: **1** (trần đã đóng băng 3; vượt trần mới làm batch vô hiệu) — F3:score:invalid_response. Lỗi authoring (`invalid_input`, không tính là client failure): **0**.
